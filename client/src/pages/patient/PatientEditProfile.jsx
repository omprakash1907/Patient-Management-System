            ...
            <form className="w-4/5 pl-8" onSubmit={handleSubmit}>
              ...
              <div className="grid grid-cols-3 gap-4">
                ...
                {[
                  ...
                  { name: "age", label: "Age" },
                  { name: "bloodGroup", label: "Blood Group", type: "select", options: ["A+", "B+", "O+", "AB+"] },
                  ...
                  <div key={name} className={`relative mb-4 ${colSpan === 3 ? "col-span-3" : ""}`}>
                    {type === "select" ? (
                      <select
                        id={name}
                        name={name}
                    ...
                    >
                      {label}
                      {["name", "number", "email", "age", "height", "weight", "gender", "bloodGroup", "dob", "country", "state", "city"].includes(name) && (
