...
const PatientEditProfile = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // Debugging: Log formDataToSend content before sending
    ...
    try {
      ...
      if (token) {
        ...
        const response = await api.patch(`/users/patients/${patientId}`, formDataToSend, {
          headers: { 
        ...
        navigate("/patient/patient-dashboard"); // Redirect after success
      }
    } catch (err) {
