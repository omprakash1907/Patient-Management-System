...
import countryData from "../../country-json/countries+states+cities.json"; // Assuming this is the correct path to your JSON file
...
const BookAppointment = () => {
    ...
    return (
        <div className="bg-white p-6 rounded-xl m-6 h-full ">
            <h2 className="text-2xl font-semibold mb-6">Appointment Booking</h2>

            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 mb-8 border p-6 rounded-xl">
                        ...
                        <div className="bg-white border rounded-xl p-4">
                            ...
                            <div className="flex items-center mb-4 relative z-10 p-4 bg-gradient-to-br from-[#4C49ED] to-[#020067]  rounded-lg shadow-lg ">
                                ...
                                <div>
                                    ...
                                    <span className={`bg-${doctorDetails.gender === "Male" ? "blue-100 bg-opacity-20" : "pink-10 "} text-${doctorDetails.gender === "Male" ? "white" : "pink-600"} px-2 py-1  rounded-full text-sm flex items-center`}>
                                        {doctorDetails.gender === "Male" ? <FaMars className="mr-1" /> : <FaVenus className="mr-1" />}
                            ...
                            <div className="bg-gray-50 p-4 rounded-lg">
                                <div className="grid grid-cols-2 gap-4 text-sm">
                                    ...
                                    <div>
                                        <p className="text-gray-500 font-medium">Specialty Type</p>
            ...
            {selectedSlot && (
                <Modal
                    ...
                    className="bg-white p-6 rounded-lg shadow-lg max-w-md mx-auto my-16 w-1/4"
                ...
                >
                    {appointmentSuccess ? (
                        <div className="text-center">
                            ...
                            <button className="mt-6 px-4 py-2 bg-green-600 w-full text-white rounded-md" onClick={closeModal}>Okay</button>
                        </div>
                    ) : (
                        <>
                            ...
                            <div className="mt-6 flex justify-between gap-3">
                                ...
                                <button
                                    ...
                                    className="px-4 py-2 bg-gray-100 hover:bg-customBlue font-medium hover:text-white transition-all ease-in-out rounded-lg w-full "
                                    disabled={loading}
                                >
                                    <span>
