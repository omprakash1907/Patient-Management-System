...
const InvoiceModal = ({ bill, onClose, onPay, showPayButton }) => {
  ...
  return (
    <div className="fixed inset-0 bg-gray-800 bg-opacity-50 flex items-center justify-center">
      <div className="bg-white  rounded-2xl max-w-3xl relative z-10 overflow-y-auto max-h-screen">
        <div className="p-6">
          {/* Close Button */}
          <button
            onClick={onClose}
          ...
          <div className="bg-gray-100 p-4 rounded-lg mb-6">
            <div className="grid grid-cols-2 gap-4">
              <p>
                <strong>Name:</strong> {bill?.patient?.firstName}{" "}
          ...
          {/* Invoice Table */}
          <table className="w-full overflow-hidden  rounded-lg mb-6">
            <thead className="bg-customBlue text-white text-left ">
              <tr>
            ...
            {bill?.insuranceDetails?.insuranceCompany && (
              <div className="mb-4">
                ...
                <p>
                  ...
                  {bill.insuranceDetails.insurancePlan}
                </p>
                <p>
                  <strong>Claim Amount:</strong> ₹{" "}
                  {bill.insuranceDetails.claimAmount}
                </p>
                <p>
                  <strong>Claimed Amount:</strong> ₹{" "}
                  {bill.insuranceDetails.claimedAmount}
                </p>
              </div>
            )}
            <div>
          ...
          {showPayButton && (
            <div className="text-center mt-4">
              <button
                className="bg-customBlue text-white py-2 px-8 rounded-xl"
                onClick={onPay}
              >
                Pay Now
              </button>
        ...
        <div className="text-center text-sm bg-customBlue p-2 rounded-b-lg text-white mt-4 flex justify-between">
